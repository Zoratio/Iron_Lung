...
public class Map {
    ...
    public Map(Scanner myScanner){
        ...
        System.out.println("""
                ...
                YOUR TASK IS TO PHOTOGRAPH THESE POINTS OF INTEREST WITH THE SM13'S CAMERA. PHOTOS MUST BE TAKEN WITHIN 0.5 UNITS OF THE POINT OF INTEREST.

                SINCE YOU CAN'T NAVIGATE BY SIGHT, PAY ATTENTION TO YOUR COORDINATES AND CONSULT THE MAP. COMPLETE YOUR TASK AND RETURN TO THE SURFACE BEFORE YOUR LIMITED OXYGEN SUPPLY RUNS OUT.
